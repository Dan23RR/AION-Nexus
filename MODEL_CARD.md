...
AION-NEXUS achieves the best reported zero-shot F1 on MFPT and the best reported 10-sample few-shot F1, with no adversarial training, no meta-training, and no target-domain data exposure during pre-training.
